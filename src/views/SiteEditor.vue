  ...
  <div class="h-full flex flex-col gap-6">
    <div class="flex justify-between items-center">
      <div class="flex items-center gap-4">
        ...
        <div>
          <h2 class="text-2xl font-serif italic">
            {{ site }}
          </h2>
    ...
    <div class="flex-grow grid grid-cols-12 gap-6 min-h-[500px]">
      ...
      <div class="col-span-3 border border-[#2A2A2A] bg-[#181818] p-2 flex flex-col gap-1 overflow-y-auto rounded shadow-inner">
        <div class="px-3 py-2 text-[10px] uppercase tracking-widest opacity-30 font-bold border-b border-[#2A2A2A] mb-2">
          Files
        </div>
        <button 
          v-for="file in files" 
      ...
      <div class="col-span-9 border border-[#2A2A2A] bg-[#0A0A0A] relative flex flex-col rounded shadow-2xl">
        <div
          v-if="!selectedFile"
          class="absolute inset-0 flex items-center justify-center opacity-20 italic"
        >
