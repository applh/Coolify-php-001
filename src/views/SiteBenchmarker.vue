  ...
  <div class="space-y-8 max-w-5xl mx-auto">
    <div class="flex justify-between items-end">
      <div class="space-y-1">
        ...
        <h2 class="text-3xl serif italic leading-none">
          Site Benchmarker
        </h2>
      </div>
      ...
      <div class="space-y-4">
        ...
        <div class="border border-[#2A2A2A] bg-[#0A0A0A] min-h-[400px] overflow-hidden">
          <div
            ...
            class="h-full flex items-center justify-center text-[10px] uppercase tracking-[0.2em] opacity-30 italic"
          >
        ...
        <div
          v-if="results.length > 0"
          class="p-4 bg-[#181818] border border-[#2A2A2A] space-y-2"
        >
