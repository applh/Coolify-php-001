...
**Reference**: `docs/training/slides/part1/dry-refactoring-best-practices.json`
...
**Reference**: `docs/training/slides/part1/file-formats.json`
...
**Reference**: `docs/training/slides/part1/software-engineering-fundamentals.json`
...
**Reference**: `docs/training/slides/part1/computer-fundamentals.json`
...
**Reference**: `docs/training/slides/part1/ai-token-usage-calculation.json`
